...
## Usage
To run the tests and show report, use the following command:
```
npm run run-and-generate-report
```
This will execute all the tests defined in the `tests/testCases` directory.
